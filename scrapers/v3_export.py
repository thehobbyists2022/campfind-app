...
(app/aca_camps_expansion_v3.json), dedupes franchise-brand overlaps, and
produces the three runtime copies:
...
def main():
    ...
    out = {
        "source": "CampFind v3 dataset — cleaned legacy + real franchise expansion",
    ...
    js = "// CampFind v3 dataset — generated by scrapers/v3_export.py\n"
